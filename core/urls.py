...
urlpatterns = [
    ...
    path('settings/backup/', views.role_required('admin')(views.backup_index), name='backup-index'),
    path('settings/backup/download/', views.role_required('admin')(views.backup_download), name='backup-download'),
    path('settings/backup/restore/', views.role_required('admin')(views.backup_restore), name='backup-restore'),
